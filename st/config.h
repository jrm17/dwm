...
static char *font = "monospace:size=10:antialias=false";
...
/* You can tell the terminal to not expand tabs by running: `stty tabs` */
unsigned int tabspaces = 8;

/* Terminal colors (16 first used in escape sequence) */
const char *colorname[] = {
	"#111111", "#EE5555", "#88BB88", "#FFCC66", "#6699CC", "#AA88CC", "#55CCFF", "#CCCCCC",
	"#222222", "#FF4444", "#66BB66", "#EE8844", "#3388EE", "#DD88DD", "#44DDEE", "#FFFFFF",
	[255] = 0,
	"#668899", "#FFFFFF",
};

/* Default colors (by index) */
unsigned int defaultfg = 7; /* foreground */
unsigned int defaultbg = 0; /* background */
static unsigned int defaultcs  = 256; /* cursor */
...
/* the table sequentially, XK_ANY_MOD should be the last definition for a key. */
